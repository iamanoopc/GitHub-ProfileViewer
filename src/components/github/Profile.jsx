        ...
        <div className="panel-body">
          <div className="row">
            <div className="col-md-4">
              <img src={this.props.userData.avatar_url} className="thhumbnail" style={{width:"100%"}}/>
            </div>
              ...
              <div className="row">
                <div className="col-md-12">
                  <ul className="list-group">
                    ...
                    <li className="list-group-item"><strong>Email: </strong>{(this.props.userData.email) ? this.props.userData.email : "Not Provided"}</li>
                  </ul>
                </div>
              </div>
              <br/>
