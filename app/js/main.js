	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'div',
	              { className: 'col-md-4' },
	              _react2['default'].createElement('img', { src: this.props.userData.avatar_url, className: 'thhumbnail', style: { width: "100%" } })
	            ),
	            _react2['default'].createElement(
	              'div',
	              { className: 'col-md-8' },
	                ...
	                _react2['default'].createElement(
	                  ...
	                  _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                      ...
	                      this.props.userData.email ? this.props.userData.email : "Not Provided"
	                    )
	                  )
	                )
	              ),
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          this.props.userRepos.map(function (repo) {
	            return _react2['default'].createElement(_RepoJsx2['default'], _extends({ repo: repo, key: repo.id }, _this.props));
	          })
	        )
	      );
	    }
